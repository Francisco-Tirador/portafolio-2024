...
const Header = () => {
  ...
  return (
    <>
      <div className='bg-black md:bg-transparent w-full h-auto md:w-[20%] md:max-w-[300px] bg-green-600s md:h-[90%] rounded-md border-third border-2 z-50 flex flex-wrap justify-between md:mx-auto ' style={{ backdropFilter: " blur(5px)" }}>
        ...
        <div className='hidden  bg-secondary1 w-[80%] mx-auto p-3 md:flex justify-around mt-auto mb-4 '>
          ...
          <a className='w-[20%] h-[100%]' href="https://www.linkedin.com/in/francisco-beltr%C3%A1n-342a31213/" target='_blank'>
            <FaLinkedin className='w-full h-full hover:text-blue-600 cursor-pointer hover:scale-105 duration-200' />
          </a>
          <a className='w-[20%] h-[100%]' href="https://api.whatsapp.com/send/?phone=5215620397081&text=Hola%20me%20gustaria%20trabajar%20con%20tigo&type=phone_number&app_absent=0" target='_blank'>
            <FaSquareWhatsapp className='w-full h-full hover:text-green-600 cursor-pointer hover:scale-105 duration-200' />
