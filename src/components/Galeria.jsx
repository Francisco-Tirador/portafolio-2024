    ...
    <>
      ...
      <div className={`bg-gray-50 rounded-t-lg overflow-y-auto absolute w-full z-20 top-[100%] ${slideOpen && "top-[5%]"} duration-200 h-full text-primary`}>
        <header className='bg-primary flex justify-between items-center p-2 sticky top-0 z-10'>
          <h4 className="text-white text-lg">GALLERIA DE PROYECTO</h4>
        ...
        <div className="p-1 overflow-y-auto">
          {
            arraySliders.map(S => (
              <div key={S.id} className="mb-4 bg-gray-300 mx-2 rounded-md px-2 py-3" >
                ...
                <p className="text-justify p-2 text-sm bg-gray-50 rounded-sm md:px-12">
                  {
                    S.descripcion
                  }
                </p>
