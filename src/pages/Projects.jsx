...
const Projects = () => {
    ...
    return (
      ...
      <div className='center contenCara overflow noneScrol col-12 '>
        {
          item &&
          <div className='conten-picture' >
          <span class="material-symbols-outlined btn-close btn-gallery" onClick={btnClose}>
          disabled_by_default
          </span>
            <images src={item} alt="" />
          </div>
        ...
        <div className='box-conten-gallery'>
          ...
          {
            ArrayProyects.map(P => (
              <div className='rounded-md bg-gray-200 p-5 mx-3 my-2 flex duration-300 hover:bg-third group '>
                <div key={P.id} className='w-[40%] min-w-[250px] h-[250px] rounded-[20px] relative '>
